...
export const GET_CATEGORY_PRODUCTS_REQUEST = "GET_PRODUCTS_REQUEST";
export const GET_CATEGORY_PRODUCTS_SUCCESS = "GET_PRODUCTS_SUCCESS";
export const GET_CATEGORY_PRODUCTS_FAIL = "GET_PRODUCTS_FAIL";
